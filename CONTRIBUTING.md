...
В операционной системе Linux необходимо установить пакет `nodejs-legacy`, выполнив команду `sudo apt install nodejs-legacy`
...
В окне редактора откройте настройки (Windows - `File -> Settings`, Linux - `Edit -> Preferences`), перейдите в раздел
